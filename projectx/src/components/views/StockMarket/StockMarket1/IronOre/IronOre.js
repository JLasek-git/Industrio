...
import styles from "./IronOre.module.scss";
  ...
  return (
    <div className={styles.materialActionsList}>
      <form className={styles.buyingForm}>
        <label htmlFor="buyingAmount">How much Iron ore you want to buy?</label>
      ...
      <form className={styles.buyingForm}>
        <label htmlFor="sellingAmount">
          How much Iron ore you want to sell?
        </label>
